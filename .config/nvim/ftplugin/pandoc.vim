...
function NotesPreview()
	...
	if !filereadable(g:pdf)
		...
		execute ':Pandoc' '--katex=/home/rayes/Notes/pandoc-utilities/katex/' '--defaults=/home/rayes/Notes/pandoc-utilities/tufte.yaml' '--output' g:pdf
	endif
...
"call NotesPreview()
nmap <silent> <C-p> :call NotesPreview()<CR>
...
setlocal dictionary+=~/.config/nvim/dictionaries/tex
